...
| --- |
| Note |
| You can add organizations located in Microsoft Entra Germany region to Veeam Backup for Microsoft 365, only using the [Add-VBOOrganization](https://helpcenter.veeam.com/docs/vbo365/powershell/add-vboorganization.html?ver=8) cmdlet or the POST /Organizations method. |
...
* Veeam Backup for Microsoft 365 does not support Microsoft Teams service and team posts (formerly team chats) backup for Microsoft organizations in Microsoft Entra Germany region.
