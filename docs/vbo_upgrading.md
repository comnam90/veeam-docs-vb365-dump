...
Veeam Backup for Microsoft 365 supports upgrade to version 8.5 from the following versions of the product:
...
* * 8 (builds 8.0.2.159, 8.0.2.200, 8.0.3.1044, 8.0.3.1073, 8.0.4.29, 8.0.5.20)
  ...
  * 8.3 (build 8.3.0.2201)
  * 8.4 (build 8.4.0.1457)
...
6. [Begin the installation process](vbo_upgrade_begin.md).
