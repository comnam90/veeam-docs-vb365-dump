...
* [Veeam Explorer for Microsoft Exchange](https://helpcenter.veeam.com/docs/vbo365/explorers/adding_exchange_databases.html?ver=8)
* [Veeam Explorer for Microsoft SharePoint](https://helpcenter.veeam.com/docs/vbo365/explorers/vesp_adding_vbo_databases.html?ver=8)
* [Veeam Explorer for Microsoft OneDrive](https://helpcenter.veeam.com/docs/vbo365/explorers/veod_adding_vbo_databases_od.html?ver=8)
* [Veeam Explorer for Microsoft Teams](https://helpcenter.veeam.com/docs/vbo365/explorers/vet_adding_vbo_databases.html?ver=8)

If backups are stored in an object storage repository, you must re-add an organization to Veeam Backup for Microsoft 365 to access the backed-up data and get restore points for this object storage repository. For example, you can get restore points for the object storage repository by running the [Get-VBORestorePoint](https://helpcenter.veeam.com/docs/vbo365/powershell/get-vborestorepoint.html?ver=8) cmdlet.
