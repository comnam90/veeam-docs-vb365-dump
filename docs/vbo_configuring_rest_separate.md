...
1. Configure REST API settings. For more information, see [Configuring REST API Settings](vbo_configuring_rest_separate_api.md).
2. Configure Restore Portal settings. For more information, see [Configuring Restore Portal Settings](vbo_configuring_rest_separate_ssp.md).
3. Click Apply.
