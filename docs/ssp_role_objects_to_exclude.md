...
![Step 6. Select Objects to Exclude](images/ssp_select_objects_to_exclude.webp "Selecting Objects to Exclude")

1. Click Add.

The selected objects appear in the list of objects to exclude.

![Step 6. Select Objects to Exclude](images/new_operator_role_6.webp "Selecting Objects to Exclude")
