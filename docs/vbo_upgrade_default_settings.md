...
| --- |
| Note |
| This step is only available if you upgrade Veeam Backup for Microsoft 365 from version 7.0 or 7a to version 8.4. |
...
| Database engine | PostgreSQL | The upgrade wizard deploys PostgreSQL 16.12 as a database engine locally on the Veeam Backup for Microsoft 365 server. |
