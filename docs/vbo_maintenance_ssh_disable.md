...
| --- |
| Note |
| If you want to disable the maintenance mode for multiple Linux-based backup proxy servers, you must specify the SSH connection settings that Veeam Backup for Microsoft 365 can use to connect to all selected Linux-based backup proxy servers. |
...
[![Disabling Maintenance Mode](images/proxy_pool_maintenance_ssh.webp)](images/proxy_pool_maintenance_ssh.webp "Disabling Maintenance Mode")
