...
1. [Launch the installation wizard](vbo_install_launch_ve.md).
2. [Select the component to install](vbo_install_select_ve.md).
3. [Read and accept the license agreement](vbo_install_agreements_ve.md).
