...
1. [Launch the Proxy Maintenance wizard](launch_new_proxy_maintenance_wizard.md).
2. [Select a backup proxy server](vbo_selecting_proxy_server_maintenance.md).
3. [Specify credentials](vbo_maintenance_creds.md).
