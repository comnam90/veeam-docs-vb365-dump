---
title: "new_s3_configure_immutability"
source_url: "https://helpcenter.veeam.com/docs/vbo365/guide/new_s3_configure_immutability.html"
...
| --- |
| Note |
| This option is unavailable if you have selected the Keep forever option at the [previous](new_s3_retention.md) step of the wizard. |
...
| --- |
| Note |
| This option is unavailable if you have selected the Item-level retention option at the [previous](new_s3_retention.md) step of the wizard. |
