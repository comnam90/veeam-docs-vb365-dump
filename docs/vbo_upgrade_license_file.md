...
If a valid license is already installed on the machine, you can skip this step and proceed to the [next step](vbo_upgrade_configuration_check.md) of the wizard.
