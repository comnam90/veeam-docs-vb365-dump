...
![Step 3. Select Backup Proxy Servers](images/add_proxies_to_proxy_pool.webp "Selecting Backup Proxy Servers")
...
![Step 3. Select Backup Proxy Servers](images/select_proxies_to_proxy_pool.webp "Selecting Backup Proxy Servers")

1. Click Add.

The selected backup proxy servers appear in the list of backup proxy servers added to the backup proxy pool.

![Step 3. Select Backup Proxy Servers](images/add_proxies_to_proxy_pool_finish.webp "Selecting Backup Proxy Servers")
