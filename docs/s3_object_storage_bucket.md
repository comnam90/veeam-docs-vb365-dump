...
1. In the Folder field, specify a folder to which you want to map your object storage repository, and which will be used to store backups.

To specify a folder, click Browse and either select an existing folder or create a new one by clicking New Folder.
