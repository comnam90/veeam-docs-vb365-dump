...
| Cmdlet | Operation |
| --- | --- |
| [Get-VBOFolderExclusions](get-vbofolderexclusions.md) | Returns backup exclusion settings. |
| [Set-VBOFolderExclusions](set-vbofolderexclusions.md) | Modifies backup exclusion settings. |
