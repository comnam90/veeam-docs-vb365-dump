...
|  |
| --- |
| Set-VBOVersionBackupOptions -Organization <VBOOrganization> -SharePointBackupMode <VBOSharePointVersionBackupMode> [<CommonParameters>] |
...
| Organization | Specifies a Microsoft organization. The cmdlet will modify the version backup options for this Microsoft organization. | VBOOrganization  Accepts the [VBOOrganization](vboorganization.md) object.  To get this object, run the [Get-VBOOrganization](get-vboorganization.md) cmdlet. | True | Named | True (ByValue) |
