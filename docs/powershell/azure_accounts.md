...
| Cmdlet | Operation |
| --- | --- |
| [Add-VBOAzureBlobAccount](add-vboazureblobaccount.md) | Creates Microsoft Azure Blob Storage account credentials. |
| [Get-VBOAzureBlobAccount](get-vboazureblobaccount.md) | Returns Microsoft Azure Blob Storage account credentials. |
