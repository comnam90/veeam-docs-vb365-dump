...
| --- | --- | --- | --- | --- | --- |
| Policy | Specifies the backup job schedule whose settings you want to modify. | Accepts the [VBOJobSchedulePolicy](vbojobschedulepolicy.md) object.  To create this object, run the [New-VBOJobSchedulePolicy](new-vbojobschedulepolicy.md) cmdlet. | True | Named | True (ByValue) |
