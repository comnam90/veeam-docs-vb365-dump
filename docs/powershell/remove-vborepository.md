...
| --- | --- | --- | --- | --- | --- |
| Repository | Specifies a backup repository. The cmdlet will remove this backup repository from the Veeam Backup for Microsoft 365 infrastructure. | Accepts the VBORepository object.  To get this object, run the [Get-VBORepository](get-vborepository.md) cmdlet. | True | Named | True (ByValue) |
