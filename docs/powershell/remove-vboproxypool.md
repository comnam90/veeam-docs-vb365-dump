...
| --- | --- | --- | --- | --- | --- |
| Pool | Specifies a backup proxy pool. The cmdlet will remove this backup proxy pool from the Veeam Backup for Microsoft 365 infrastructure. | Accepts the VBOProxyPool object.  To get this object, run the [Get-VBOProxyPool](get-vboproxypool.md) cmdlet. | True | Named | True (ByValue) |
