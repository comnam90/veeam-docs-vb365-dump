...
* Modify a backup job settings.

|  |
| --- |
| Set-VBOJob -Job <VBOJob> [-Name <String>] [-Repository <VBORepository>] [-Description <String>] [-RunJob] [-SchedulePolicy <VBOJobSchedulePolicy>] [-EnableSelectedOneDriveFolders] [-EnableExcludedOneDriveFolders] [<CommonParameters>] |
