...
>[PowerShell Reference](https://helpcenter.veeam.com/docs/vbo365/powershell/)>[Veeam Backup for Microsoft 365 PowerShell Reference](./veeam_psreference.md)>[External Authentication Providers](./external_auth_providers.md)>Add-VBOFederatedAuthenticationAuthority
