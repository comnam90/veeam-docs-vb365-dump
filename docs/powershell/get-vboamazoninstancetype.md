...
>[PowerShell Reference](https://helpcenter.veeam.com/docs/vbo365/powershell/)>[Veeam Backup for Microsoft 365 PowerShell Reference](./veeam_psreference.md)>[Backup Infrastructure](./backup_infrastructure.md)>[Archiver Appliances](./archiver_appliances.md)>Get-VBOAmazonInstanceType
...
This cmdlet returns the [VBOAmazonInstanceType](vboamazoninstancetype.md) object.
...
The cmdlet returns the [VBOAmazonInstanceType](vboamazoninstancetype.md) object that the Amazon archiver appliance will use.
