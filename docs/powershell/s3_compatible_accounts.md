...
| Cmdlet | Operation |
| --- | --- |
| [Add-VBOAmazonS3CompatibleAccount](add-vboamazons3compatibleaccount.md) | Creates S3 Compatible storage account credentials. |
| [Get-VBOAmazonS3CompatibleAccount](get-vboamazons3compatibleaccount.md) | Returns S3 Compatible storage account credentials. |
