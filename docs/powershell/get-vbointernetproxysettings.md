...
>[PowerShell Reference](https://helpcenter.veeam.com/docs/vbo365/powershell/)>[Veeam Backup for Microsoft 365 PowerShell Reference](./veeam_psreference.md)>[Global Internet Proxy Server Settings](./global_internet_proxy_server_settings.md)>Get-VBOInternetProxySettings
