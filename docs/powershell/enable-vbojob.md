...
>[PowerShell Reference](https://helpcenter.veeam.com/docs/vbo365/powershell/)>[Veeam Backup for Microsoft 365 PowerShell Reference](./veeam_psreference.md)>[Data Backup](./data_backup.md)>[Managing Backup Jobs](./managing_jobs.md)>Enable-VBOJob
...
| --- | --- | --- | --- | --- | --- |
| Job | Specifies a backup job that you want to enable. | Accepts the [VBOJob](vbojob.md) object.  To get this object, run the [Get-VBOJob](get-vbojob.md) cmdlet. | True | Named | True (ByValue) |
