...
>[PowerShell Reference](https://helpcenter.veeam.com/docs/vbo365/powershell/)>[Veeam Backup for Microsoft 365 PowerShell Reference](./veeam_psreference.md)>[Backup Infrastructure](./backup_infrastructure.md)>[Microsoft Azure Blob Storage Settings](./azure_object_storage.md)>[Microsoft Azure Blob Storage Accounts](./azure_accounts.md)>Remove-VBOAzureBlobAccount
