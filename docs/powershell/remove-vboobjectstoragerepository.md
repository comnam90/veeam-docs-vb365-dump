...
| --- | --- | --- | --- | --- | --- |
| ObjectStorageRepository | Specifies an object storage repository that you want to remove from the Veeam Backup for Microsoft 365 infrastructure. | Accepts the [VBOObjectStorageRepository](vboobjectstoragerepository.md) object.  To get this object, run the [Get-VBOObjectStorageRepository](get-vboobjectstoragerepository.md) cmdlet. | True | Named | True (ByValue) |
