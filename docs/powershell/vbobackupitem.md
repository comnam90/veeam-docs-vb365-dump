...
product: "vb365"
doc_type: "powershell"
source_url: "https://helpcenter.veeam.com/docs/vbo365/powershell/vbobackupitem.html"
...
>[PowerShell Reference](https://helpcenter.veeam.com/docs/vbo365/powershell/)>[Veeam Backup for Microsoft 365 PowerShell Types](./powershell_types.md)>VBOBackupItem

# VBOBackupItem


Contains details about a Microsoft organization object.

| Property | Type | Description |
| --- | --- | --- |
| Type | VBOBackupItemType | Object type. Possible values:   * Site * Organization * SecurityGroup * DistributionGroup * DynamicDistributionGroup * O365Group * PublicMailbox * SharedMailbox * User * PersonalSites * Team |

Parent type of the following objects:

* [VBOBackupDistributionGroup](vbobackupdistributiongroup.md)
* [VBOBackupDynamicDistributionGroup](vbobackupdynamicdistributiongroup.md)
* [VBOBackupGroup](vbobackupgroup.md)
* [VBOBackupO365Group](vbobackupo365group.md)
* [VBOBackupOrganization](vbobackuporganization.md)
* [VBOBackupPersonalSites](vbobackuppersonalsites.md)
* [VBOBackupPublicMailbox](vbobackuppublicmailbox.md)
* [VBOBackupSecurityGroup](vbobackupsecuritygroup.md)
* [VBOBackupSharedMailbox](vbobackupsharedmailbox.md)
* [VBOBackupSite](vbobackupsite.md)
* [VBOBackupTeam](vbobackupteam.md)
* [VBOBackupUser](vbobackupuser.md)
