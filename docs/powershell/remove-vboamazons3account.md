...
>[PowerShell Reference](https://helpcenter.veeam.com/docs/vbo365/powershell/)>[Veeam Backup for Microsoft 365 PowerShell Reference](./veeam_psreference.md)>[Backup Infrastructure](./backup_infrastructure.md)>[Amazon Storage Settings](./amazon_object_storage.md)>[Amazon S3 Accounts](./amazon_s3_accounts.md)>Remove-VBOAmazonS3Account
...
| --- | --- | --- | --- | --- | --- |
| Account | Specifies Amazon S3 storage account credentials that you want to remove. | Accepts the [VBOAmazonS3Account](vboamazons3account.md) object.  To get this object, run the [Get-VBOAmazonS3Account](get-vboamazons3account.md) cmdlet. | True | Named | True (ByValue) |
