...
>[PowerShell Reference](https://helpcenter.veeam.com/docs/vbo365/powershell/)>[Veeam Backup for Microsoft 365 PowerShell Reference](./veeam_psreference.md)>[Backup Copy](./backup_copy.md)>[Backup Copy Jobs](./backup_copy_jobs.md)>Get-VBOCopyJob
