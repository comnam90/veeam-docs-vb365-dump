...
>[PowerShell Reference](https://helpcenter.veeam.com/docs/vbo365/powershell/)>[Veeam Backup for Microsoft 365 PowerShell Reference](./veeam_psreference.md)>[Managing Veeam Backup for Microsoft 365](./connect_to_veeam_backup_office365_server.md)>Get-VBOVersion
