...
>[PowerShell Reference](https://helpcenter.veeam.com/docs/vbo365/powershell/)>[Veeam Backup for Microsoft 365 PowerShell Reference](./veeam_psreference.md)>[Data Backup](./data_backup.md)>[Backup Jobs](./backup_jobs.md)>Remove-VBOJob
