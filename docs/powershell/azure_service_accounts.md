...
| Cmdlet | Operation |
| --- | --- |
| [Add-VBOAzureServiceAccount](add-vboazureserviceaccount.md) | Creates Microsoft Azure service accounts. |
| [Get-VBOAzureServiceAccount](get-vboazureserviceaccount.md) | Returns Microsoft Azure service account details. |
| [Set-VBOAzureServiceAccount](set-vboazureserviceaccount.md) | Modifies Microsoft Azure service account settings. |
