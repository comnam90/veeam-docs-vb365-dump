...
>[PowerShell Reference](https://helpcenter.veeam.com/docs/vbo365/powershell/)>[Veeam Backup for Microsoft 365 PowerShell Reference](./veeam_psreference.md)>[Backup Copy](./backup_copy.md)>[Managing Backup Copy Jobs](./managing_copy_jobs.md)>Enable-VBOCopyJob
