...
| Cmdlet | Operation |
| --- | --- |
| [Get-VBOMailboxProtectionReport](get-vbomailboxprotectionreport.md) | Generates reports on the protection of mailboxes by Veeam Backup for Microsoft 365. |
| [Get-VBOStorageConsumptionReport](get-vbostorageconsumptionreport.md) | Generates reports on the Veeam Backup for Microsoft 365 storage consumption. |
