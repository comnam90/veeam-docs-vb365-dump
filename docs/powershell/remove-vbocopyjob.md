...
>[PowerShell Reference](https://helpcenter.veeam.com/docs/vbo365/powershell/)>[Veeam Backup for Microsoft 365 PowerShell Reference](./veeam_psreference.md)>[Backup Copy](./backup_copy.md)>[Backup Copy Jobs](./backup_copy_jobs.md)>Remove-VBOCopyJob
...
| --- | --- | --- | --- | --- | --- |
| Job | Specifies a backup copy job that you want to remove. | Accepts the [VBOCopyJob](vbocopyjob.md) object.  To get this object, run the [Get-VBOCopyJob](get-vbocopyjob.md) cmdlet. | True | Named | True (ByValue) |
