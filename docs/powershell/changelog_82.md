...
>[PowerShell Reference](https://helpcenter.veeam.com/docs/vbo365/powershell/)>[Veeam Backup for Microsoft 365 PowerShell Changelog](./ps_changelog.md)>v8.2 Changelog

# v8.2 Changelog


This section describes updated PowerShell cmdlets in Veeam Backup for Microsoft 365 8.2 comparing to 8.1.1.
...
| [Stop-VBOCopyJob](stop-vbocopyjob.md) | Parameter added: Force |
