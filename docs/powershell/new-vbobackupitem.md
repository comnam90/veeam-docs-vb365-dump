...
For more information on object types, see the [Organization Object Types](https://helpcenter.veeam.com/docs/vbo365/guide/vbo_object_types.html?ver=8) section of the Veeam Backup for Microsoft 365 User Guide.
...
| TeamsChats | Defines that the cmdlet will create an organization object that will have the team posts (formerly team chats) option enabled.  Default: False | SwitchParameter | False | Named | False |
