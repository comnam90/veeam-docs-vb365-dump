...
[Add-VBOAmazonS3Account](add-vboamazons3account.md)

[Add-VBOAmazonS3CompatibleAccount](add-vboamazons3compatibleaccount.md)
...
[Add-VBOAzureBlobAccount](add-vboazureblobaccount.md)

[Add-VBOAzureBlobFolder](add-vboazureblobfolder.md)
...
[Add-VBOEncryptionKey](add-vboencryptionkey.md)

[Add-VBOExcludedBackupItem](add-vboexcludedbackupitem.md)

[Add-VBOFederatedAuthenticationAuthority](add-vbofederatedauthenticationauthority.md)
...
[Connect-VBOServer](connect-vboserver.md)
...
[Disconnect-VBOServer](disconnect-vboserver.md)
...
[Get-VBOCommand](get-vbocommand.md)

[Get-VBOCopyJob](get-vbocopyjob.md)

[Get-VBODataManagementSession](get-vbodatamanagementsession.md)
...
[Get-VBOGlobalRetentionExclusion](get-vboglobalretentionexclusion.md)
...
[Get-VBOLicenseOverviewReport](get-vbolicenseoverviewreport.md)
...
[Get-VBOOperatorAuthenticationSettings](get-vbooperatorauthenticationsettings.md)
...
[Get-VBOServer](get-vboserver.md)

[Get-VBOServerComponents](get-vboservercomponents.md)

[Get-VBOStorageConsumptionReport](get-vbostorageconsumptionreport.md)
...
[Get-VBOVersion](get-vboversion.md)

Install

[Install-VBOLicense](install-vbolicense.md)
...
[New-VBOAmazonS3ServiceConnectionSettings](new-vboamazons3serviceconnectionsettings.md)
...
[Remove-VBOAmazonS3Account](remove-vboamazons3account.md)

[Remove-VBOAmazonS3CompatibleAccount](remove-vboamazons3compatibleaccount.md)

[Remove-VBOAzureBlobAccount](remove-vboazureblobaccount.md)
...
[Remove-VBOEncryptionKey](remove-vboencryptionkey.md)

[Remove-VBOEntityData](remove-vboentitydata.md)

[Remove-VBOExcludedBackupItem](remove-vboexcludedbackupitem.md)

[Remove-VBOFederatedAuthenticationAuthority](remove-vbofederatedauthenticationauthority.md)
...
[Remove-VBOOrganizationRetentionExclusion](remove-vboorganizationretentionexclusion.md)
...
[Set-VBOAmazonS3Account](set-vboamazons3account.md)

[Set-VBOAmazonS3CompatibleAccount](set-vboamazons3compatibleaccount.md)
...
[Set-VBOGlobalRetentionExclusion](set-vboglobalretentionexclusion.md)
...
[Set-VBOOperatorAuthenticationSettings](set-vbooperatorauthenticationsettings.md)

[Set-VBOOrganization](set-vboorganization.md)

[Set-VBOOrganizationRetentionExclusion](set-vboorganizationretentionexclusion.md)
...
[Set-VBOPSQLDatabaseServerLimits](set-vbopsqldatabaseserverlimits.md)
...
[Stop-VBORepositoryOwnerChangeSession](stop-vborepositoryownerchangesession.md)

[Stop-VBORepositorySynchronizeSession](stop-vborepositorysynchronizesession.md)

[Stop-VBORepositoryUpgradeSession](stop-vborepositoryupgradesession.md)
...
[Uninstall-VBOLicense](uninstall-vbolicense.md)

Update

[Update-VBOLicense](update-vbolicense.md)
