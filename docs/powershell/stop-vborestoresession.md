...
| --- | --- | --- | --- | --- | --- |
| Session | Specifies a restore session that you want to stop. | Accepts the VBORestoreSession object.  To get this object, run the [Get-VBORestoreSession](get-vborestoresession.md) cmdlet. | True | Named | True (ByValue) |
