...
|  |
| --- |
| New-VBOAmazonS3ServiceConnectionSettings -Account <VBOAmazonS3Account> -RegionType <VBOAmazonS3RegionType> [<CommonParameters>] |
...
|  |  |
| --- | --- |
| This example shows how to connect to Amazon S3 object storage repository of the China region type.  |  | | --- | | $account = Get-VBOAmazonS3Account -Id f7e0a65d-1042-4ab0-bc73-699acbb5cb79  New-VBOAmazonS3ServiceConnectionSettings -Account $account -RegionType China |  Perform the following steps:   1. Run the [Get-VBOAmazonS3Account](get-vboamazons3account.md) cmdlet. Specify the Id parameter value. Save the result to the $account variable. 2. Run the New-VBOAmazonS3ServiceConnectionSettings cmdlet. Set the $account variable as the Account parameter value. Specify the RegionType parameter value. |
