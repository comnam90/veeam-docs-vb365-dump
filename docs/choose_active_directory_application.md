...
Use this scenario if you have not selected the Teams posts check box at the [Select Organization Deployment Type](vbo_add_o365_sd.md) step of the wizard.
...
For Microsoft Teams and Team Posts Backup

Use this scenario if you have selected the Teams posts check box at the [Select Organization Deployment Type](vbo_add_o365_sd.md) step of the wizard.

|  |
| --- |
| Note |
| If you want to back up team posts, registering a new Microsoft Entra application is unavailable. |
